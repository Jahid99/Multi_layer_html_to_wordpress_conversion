...
<div id="templatemo_content_wrapper">
        ...
        <h4><?php echo  $multi_layer['contact_title']; ?></h4>
        <?php echo  $multi_layer['contact_description']; ?>
        
        <h4> <?php echo ($multi_layer['send_us']); ?></h4>
        <div id="contact_form">
        
            <?php echo do_shortcode('[contact-form-7 id="240" title="Contact Form"]'); ?>
        </div>
