...
class WPCF7_ContactFormTemplate {
 ...
 [email* email id:email class:form-control placeholder "Enter Your E-mail"]
         </div>
   <div class="form-group form-group-message">
     <label class="control-label" for="message">MESSAGE *</label>
 [textarea message id:message class:form-control class:textarea-height]
       </div>           
 [submit class:btn class:btn-primary class:test "Submit"]
  </fieldset>
		';
